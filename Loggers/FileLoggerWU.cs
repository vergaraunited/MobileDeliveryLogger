...
{
    public class FileLoggerWU : BaseLogger, iLogger
    {
        #region "Variables"  
        ...
        public FileLoggerWU(string appName, string path, iEventLogger evntLogger = null) : base(appName)
        {
            ...
            //StorageFile.CreateStreamedFileAsync("output.log");
